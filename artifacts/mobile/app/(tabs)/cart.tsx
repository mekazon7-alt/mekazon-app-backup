  ...
  return (
    <View style={[styles.screen, { backgroundColor: colors.background }]}>
          ...
          <View style={styles.deliveryOptions}>
            {DUBAI_DELIVERY_OPTIONS.map((opt) => {
              ...
              return (
                ...
                >
                  <Text style={[styles.deliveryOptionLabel, { color: active ? "#FFFFFF" : colors.foreground }]}>
                    {opt.label}
                  </Text>
                  <Text style={[styles.deliveryOptionFee, { color: active ? "rgba(255,255,255,0.85)" : colors.mutedForeground }]}>
                    AED {opt.fee}
                  </Text>
                  {opt.id === "express" && (
                    <Text style={[styles.deliveryOptionDesc, { color: active ? "rgba(255,255,255,0.7)" : colors.mutedForeground }]}>
      ...
      {items.length === 0 ? (
        ...
        /* ── MAIN LAYOUT: items list + summary stacked, both scrollable ── */
        <ScrollView
        ...
        >
          ...
          {/* Summary box — sits right below items, scrolls with them */}
          <View style={[styles.summaryBox, { backgroundColor: colors.secondary, borderColor: colors.border }]}>
            ...
            <View style={styles.summaryRow}>
              <View style={styles.summaryLabelRow}>
                ...
                <Text style={[styles.summaryHint, { color: colors.mutedForeground }]}>on products</Text>
              </View>
              <Text style={[styles.summaryValue, { color: colors.foreground }]}>
            ...
            <View style={styles.summaryRow}>
              ...
              <Text style={[styles.summaryValue, { color: colors.foreground }]}>
                {deliveryFee !== null
                  ...
                  : selectedEmirate ? "..." : "Choose location"}
              </Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  deliveryOptionLabel: { fontSize: 12, fontWeight: "700" },
  deliveryOptionFee: { fontSize: 13, fontWeight: "800", letterSpacing: -0.3 },
  deliveryOptionDesc: { fontSize: 9, fontWeight: "500", letterSpacing: 0.1, textAlign: "center" },
  emptyState: {
    flex: 1,
    alignItems: "center",
  ...
  itemThumbContain: { width: "80%", height: "80%" },
  itemThumbCover: { width: "100%", height: "100%" },
  itemThumbDot: { width: 22, height: 22, borderRadius: 11, opacity: 0.7 },
